...
rocks <- read.csv(url("https://raw.githubusercontent.com/congruili/DTDI-DataAnalysis/master/rocks.csv"))
color <- read.csv(url("https://raw.githubusercontent.com/congruili/DTDI-DataAnalysis/master/color.csv"))
